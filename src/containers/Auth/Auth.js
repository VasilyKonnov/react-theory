  ...
  loginHandler = async () => {
    ...
    try {
      const response = await axios.post(
        "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyCu_1HV-czSaBdYrlpW3iiWksMVHEUzXvs",
        authData
      );
    } catch (e) {
      console.log(e);
      ...
      <div className={classes["Auth"]}>
        <div>
          ...
          <form onSubmit={this.subminHandler} className={classes["AuthForm"]}>
            ...
            <Button className="primary" onClick={this.registerHandler}>
              Регистрация
            </Button>
          </form>
        </div>
